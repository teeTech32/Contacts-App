...
function ContactForm(){
  ...
  const { setAddform, addform,fetchContacts, formData, setFormData } = useContext(contactContext)
  const { first_name, last_name, email, mobile_no, country_name, state_name, } = formData
  ...
  return <Modal isOpen={addform}>
          <div class="flex justify-center mb-0 mt-10">
                ...
                <DeletIcon onClick={handleForm} class="absolute text-2xl font-bold top-0 right-0 hover:bg-red-600 cursor-pointer" />
                  ...
                  <div class="mr-5 ml-3 mb-5 mt-5">
                    <div class="inline-flex justify-between ml-2 gap-16">
                      ...
                      <input id="first_name" value={first_name} onChange={handleOnchange} class="input input-sm w-sm pr-30 mr-0  ml-19 hover:bg-blue-200" placeholder="First_Name" type="text" required />
                    </div>
                    <div class="inline-flex justify-between mt-2 p-2 gap-16">
                      ...
                      <input id="last_name" value={last_name} onChange={handleOnchange} class="input input-sm w-sm pr-30 mr-0 ml-19 hover:bg-blue-200" placeholder="Last_Name" type="text" required />
                    </div>
                    ...
                    <div class="inline-flex justify-between p-2 gap-7">
                      ...
                      <input id="mobile_no" value={mobile_no} onChange={handleOnchange} class="input input-sm w-sm pr-30 mr-0 ml-19 hover:bg-blue-200" placeholder="Phone_Number" type="text" required />
                    </div>
                    <div class="inline-flex justify-between pl-2 pr-0 pt-2  gap-40">
                      ...
                      <select id="country_name" value={country_name} onChange={handleOnchange} class="input input-sm w-sm pr-30 ml-19 hover:bg-blue-200 " placeholder="Country_Name" type="multiple" required >
                    ...
                    <div class="inline-flex  p-3 gap-36">
                      ...
                      <select id="state_name" value={state_name} onChange={handleOnchange} class="input input-sm w-sm pr-30 mr-0 ml-19 hover:bg-blue-200" placeholder="State_Name" type="multiple" required>
                    ...
                    <div class="inline-flex justify-between pl-2 gap-1">
                      ...
                      <input id="files" class="input input-sm w-30 pr-0 mr-0 ml-19 hover:bg-blue-200" type="file"
                      accept='.jpg,.png,.jpeg' />
                    </div>
                  </div>
                  <div class="flex inlineflex mb-5  float-right mr-5 ">     
                    <button type="submit" class="btn btn-sm  hover:bg-blue-500 font-bold text-black hover:text-white align-middle rounded-full">
                      Add Contact
                    </button>
                  </div>
                </form>
                <button type="submit" onClick={clearDetails} class="btn btn-sm ml-5  hover:bg-blue-500 text-black font-bold hover:text-white inline rounded-full" >
                  Cancel
                </button>
              </div>
            </div>
